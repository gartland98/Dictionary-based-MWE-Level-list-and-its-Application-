...
''' make word list'''
lemma_wordlist=[i for i in lemma_tv if i not in phrase_lemmalist]
lemma_wordlist=[clean_text_word(i) for i in lemma_wordlist]

print('lemma wordlist:',len(lemma_wordlist))

os.chdir('C:/Users/gartl/Documents')

TV_MWElist_file=open('./TV_MWE0.txt','w',encoding='utf-8')
for i in phrase_list:
    TV_MWElist_file.write(i+'\n')
TV_MWElist_file.close()

lemma_TV_MWElist_file=open('./lemma_TV_MWE0.txt','w',encoding='utf-8')
for i in phrase_lemmalist:
    lemma_TV_MWElist_file.write(i+'\n')
lemma_TV_MWElist_file.close()

lemma_TV_wordlist_file=open('./TVcount0.txt','w',encoding='utf-8')
for i in lemma_wordlist:
