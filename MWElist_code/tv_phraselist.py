...
tv_data_path=[]
tv_data=os.listdir('./coca_spoken')
for i in tv_data:
    tv_data_path.append(os.path.join(os.getcwd(),'coca_spoken',i))
...
TV_MWElist_file=open('./coca_spoken_MWE1.txt','w',encoding='utf-8')
for i in phrase_list:
    TV_MWElist_file.write(i+'\n')
TV_MWElist_file.close()

lemma_TV_MWElist_file=open('./lemma_coca_spoken_MWE1.txt','w',encoding='utf-8')
for i in phrase_lemmalist:
    lemma_TV_MWElist_file.write(i+'\n')
lemma_TV_MWElist_file.close()

lemma_TV_wordlist_file=open('./coca_spoken_count1.txt','w',encoding='utf-8')
