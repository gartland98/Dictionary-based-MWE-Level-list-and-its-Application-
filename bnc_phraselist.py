...
print([i for i in phrase if i=='comic strip'])
print([i for i in phrase if i=='will have'])
print([i for i in phrase if i=='file for these'])
...
for i in sentences:
    cleaned_sentence = []
    for j in i:
        cleaned_sentence.append(clean_text(j))
...
phrase_file=open("BNC_MWE_lemmalist.txt", 'w',encoding='utf-8')
